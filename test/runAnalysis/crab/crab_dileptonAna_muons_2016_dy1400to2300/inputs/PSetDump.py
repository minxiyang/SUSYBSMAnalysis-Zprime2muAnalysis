...
process.Our2016Leptons = cms.EDProducer("Zprime2muLeptonProducer_miniAOD",
    ...
    muon_cuts = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits >= 1 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && ( numberOfMatchedStations > 1 || (numberOfMatchedStations == 1 && !(stationMask == 1 || stationMask == 16)) || (numberOfMatchedStations == 1 && (stationMask == 1 || stationMask == 16) && numberOfMatchedRPCLayers > 2))'),
...
process.Our2016MuPrescaledCommonLeptons = cms.EDProducer("Zprime2muLeptonProducer_miniAOD",
    bits = cms.InputTag("TriggerResults","","HLT"),
    electron_id = cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70Bitmap"),
    electron_muon_veto_dR = cms.double(-1),
    electron_src = cms.InputTag("slimmedElectrons"),
    ...
    hlt_filter_ele = cms.vstring('hltDiEle33CaloIdLMWPMS2UnseededFilter'),
    l1_filter_ele = cms.string('hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter'),
    muon_cuts = cms.string('isGlobalMuon && isTrackerMuon && pt > 27 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits >= 1 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && ( numberOfMatchedStations > 1 || (numberOfMatchedStations == 1 && !(stationMask == 1 || stationMask == 16)) || (numberOfMatchedStations == 1 && (stationMask == 1 || stationMask == 16) && numberOfMatchedRPCLayers > 2))'),
    muon_photon_match_src = cms.InputTag("muonPhotonMatchMiniAOD"),
    muon_src = cms.InputTag("slimmedMuons"),
    muon_srcSecond = cms.InputTag("slimmedMuons"),
    muon_track_for_momentum = cms.string('TunePNew'),
...
process.Our2016MuPrescaledCommonMuonsPlusMuonsMinus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    ...
    src = cms.InputTag("allOur2016MuPrescaledCommonMuonsPlusMuonsMinus"),
    vertex_chi2_max = cms.double(20)
)


process.Our2016MuPrescaledLeptons = cms.EDProducer("Zprime2muLeptonProducer_miniAOD",
    bits = cms.InputTag("TriggerResults","","HLT"),
    electron_id = cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70Bitmap"),
    electron_muon_veto_dR = cms.double(-1),
    electron_src = cms.InputTag("slimmedElectrons"),
...
process.Our2016MuPrescaledMuonsPlusMuonsMinus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    ...
    prefer_Z = cms.bool(False),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuPrescaledMuonsPlusMuonsMinus"),
    vertex_chi2_max = cms.double(20)
)
...
process.allOur2016MuPrescaledCommonMuonsPlusMuonsMinus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == 0'),
    decay = cms.string('Our2016MuPrescaledCommonLeptons:muons@+ Our2016MuPrescaledCommonLeptons:muons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 27 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits >= 1 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && ( numberOfMatchedStations > 1 || (numberOfMatchedStations == 1 && !(stationMask == 1 || stationMask == 16)) || (numberOfMatchedStations == 1 && (stationMask == 1 || stationMask == 16) && numberOfMatchedRPCLayers > 2))'),
    tight_cut = cms.string('userFloat("prescaledMu27_TriggerMatchPt")>=27 || userFloat("prescaledTkMu27_TriggerMatchPt")>=27 ')
)


process.allOur2016MuPrescaledMuonsPlusMuonsMinus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == 0'),
    decay = cms.string('Our2016MuPrescaledLeptons:muons@+ Our2016MuPrescaledLeptons:muons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 27 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits >= 1 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && ( numberOfMatchedStations > 1 || (numberOfMatchedStations == 1 && !(stationMask == 1 || stationMask == 16)) || (numberOfMatchedStations == 1 && (stationMask == 1 || stationMask == 16) && numberOfMatchedRPCLayers > 2))'),
    tight_cut = cms.string('userFloat("prescaledMu27_TriggerMatchPt")>=27 || userFloat("prescaledTkMu27_TriggerMatchPt")>=27 ')
)
...
process.allOur2016MuonsPlusMuonsMinus = cms.EDProducer("Zprime2muCombiner",
    ...
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits >= 1 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && ( numberOfMatchedStations > 1 || (numberOfMatchedStations == 1 && !(stationMask == 1 || stationMask == 16)) || (numberOfMatchedStations == 1 && (stationMask == 1 || stationMask == 16) && numberOfMatchedRPCLayers > 2))'),
    tight_cut = cms.string('userFloat("Mu50_TriggerMatchPt")>=50 || userFloat("TkMu50_TriggerMatchPt")>=50 ')
)
...
process.PrescaleToCommon = cms.EDFilter("PrescaleToCommon_miniAOD",
    ...
    overall_prescale = cms.int32(320),
...
process.Our2016MuPrescaledCommonMuonsPlusMuonsMinusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    LHEInfo = cms.InputTag("source"),
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuPrescaledCommonMuonsPlusMuonsMinus"),
    ...
    lepton_src = cms.InputTag("Our2016MuPrescaledCommonLeptons","muons"),
...
process.Our2016MuPrescaledMuonsPlusMuonsMinusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    LHEInfo = cms.InputTag("source"),
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuPrescaledMuonsPlusMuonsMinus"),
    doElectrons = cms.bool(False),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
    ...
    lepton_src = cms.InputTag("Our2016MuPrescaledLeptons","muons"),
    leptonsFromDileptons = cms.bool(True),
    lrWeightProducer = cms.PSet(
        Lambda = cms.int32(16000),
        calculate = cms.bool(False),
...
process.pathOur2016MuPrescaledCommon = cms.Path(process.PrescaleToCommon+process.primaryVertexMiniAOD+process.EventCounter+process.prefiringweight+process.dileptonPreseletor+process.muonPhotonMatchMiniAOD+process.egmGsfElectronIDSequence+process.Our2016MuPrescaledCommonLeptons+process.allOur2016MuPrescaledCommonMuonsPlusMuonsMinus+process.Our2016MuPrescaledCommonMuonsPlusMuonsMinus+process.Our2016MuPrescaledCommonMuonsPlusMuonsMinusHistos)


process.pathOur2016 = cms.Path(process.primaryVertexMiniAOD+process.EventCounter+process.prefiringweight+process.dileptonPreseletor+process.muonPhotonMatchMiniAOD+process.egmGsfElectronIDSequence+process.Our2016Leptons+process.allOur2016MuonsPlusMuonsMinus+process.Our2016MuonsPlusMuonsMinus+process.Our2016MuonsPlusMuonsMinusHistos+process.prunedMCLeptons+process.SimpleNtupler)


process.pathOur2017 = cms.Path(process.primaryVertexMiniAOD+process.EventCounter+process.prefiringweight+process.dileptonPreseletor+process.muonPhotonMatchMiniAOD+process.egmGsfElectronIDSequence+process.Our2017Leptons+process.allOur2017MuonsPlusMuonsMinus+process.Our2017MuonsPlusMuonsMinus+process.Our2017MuonsPlusMuonsMinusHistos)


process.pathOur2016MuPrescaled = cms.Path(process.primaryVertexMiniAOD+process.EventCounter+process.prefiringweight+process.dileptonPreseletor+process.muonPhotonMatchMiniAOD+process.egmGsfElectronIDSequence+process.Our2016MuPrescaledLeptons+process.allOur2016MuPrescaledMuonsPlusMuonsMinus+process.Our2016MuPrescaledMuonsPlusMuonsMinus+process.Our2016MuPrescaledMuonsPlusMuonsMinusHistos)


process.pathOur2017MuPrescaledCommon = cms.Path(process.PrescaleToCommon+process.primaryVertexMiniAOD+process.EventCounter+process.prefiringweight+process.dileptonPreseletor+process.muonPhotonMatchMiniAOD+process.egmGsfElectronIDSequence+process.Our2017MuPrescaledCommonLeptons+process.allOur2017MuPrescaledCommonMuonsPlusMuonsMinus+process.Our2017MuPrescaledCommonMuonsPlusMuonsMinus+process.Our2017MuPrescaledCommonMuonsPlusMuonsMinusHistos)


process.pathOur2017MuPrescaled = cms.Path(process.primaryVertexMiniAOD+process.EventCounter+process.prefiringweight+process.dileptonPreseletor+process.muonPhotonMatchMiniAOD+process.egmGsfElectronIDSequence+process.Our2017MuPrescaledLeptons+process.allOur2017MuPrescaledMuonsPlusMuonsMinus+process.Our2017MuPrescaledMuonsPlusMuonsMinus+process.Our2017MuPrescaledMuonsPlusMuonsMinusHistos)
